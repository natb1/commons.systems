...
> Projected from commons.systems/disposition-graph/class-recommendation (unanswered; stage review). Generated by packages/disposition/project.mjs --rules; do not edit. If this file conflicts with the graph on the disposition ref, the graph wins.
