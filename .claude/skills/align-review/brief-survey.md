...
- `ruling`, on at most one option per fact, is the author's own act: `{response: confirm|edit, date, of}`, where `of` pins the hash of the recommendation the ruling answered. Only the author rules.
