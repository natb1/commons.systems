...
`/dispatch-ladder-eval <node-id> <phase> --since <epoch>`
...
re-litigate it. `.claude/skills/dispatch-token-audit/SKILL.md` step 4 tags every
...
- `--sensor` names the instrument. `dispatch-ladder-eval` for the occurrence
