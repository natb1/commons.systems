...
Full = `title, body, comments, number, state`. Summary = `title, number, state`. Consumers that need additional fields (e.g., evaluation workflows use `labels, assignees`) extend the base set.
