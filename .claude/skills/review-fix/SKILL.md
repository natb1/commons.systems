...
In an autonomous `/dispatch-propagate` background job there is no user to drive Step 10 —
...
any fixes were made, so `/dispatch-propagate` can always advance to the next phase.
