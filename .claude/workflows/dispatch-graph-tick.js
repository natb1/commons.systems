...
function nodePrompt(sel, projectRoot) {
  ...
  return [
    ...
    'A worktree carrying commits or edits beyond the branch base, or a PR carrying prior phase comments, is resume input, not an error: diff against the base, read the prior comments, and continue — never redo completed work, never treat the dirty state as a failure. Session attach/resume is not a recovery path; the durable artifacts are.',
    '',
