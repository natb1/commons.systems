...
const classifyPrompt = [
  ...
  '  confirmation, not a code change: routing it "opus-fixable" sends it to the',
  '  fix-planner, which cannot author a fix for a no-change sign-off and',
  '  deviates. This clause covers ONLY internal, revisable measurement/audit',
  '  artifacts; a user-facing or irreversible design sign-off stays "needs-human".',
  '',
