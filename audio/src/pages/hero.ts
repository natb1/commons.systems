export function renderHero(): string {
  ...
  <div class="hero-chips" id="hero-chips">
    <div class="hero-chip-row">
      <button type="button" class="hero-chip" data-panel="panel-listen" aria-expanded="false">
        <span class="chip-badge chip-badge--easy">Easy</span>
        Upload and listen to audio
      </button>
    ...
    <div class="hero-chip-panel" id="panel-listen" hidden>
      <h3>Upload and listen to audio</h3>
      <ol>
  ...
  <details class="hero-faq">
    ...
    <div class="hero-faq-body">
      <dl>
        <dt>How is this different from using Spotify or Apple Music?</dt>
        <dd>This tool is entirely built using Claude. You should try creating your own audio player using Claude. This is only a demonstration that you can use as a reference. It includes some of my preferences — like controlling where my audio files are stored.</dd>
