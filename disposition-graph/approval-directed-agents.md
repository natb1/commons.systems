...
review:
  survey:
    ...
    text:
      question: "226892c9824ec3d1dd5b2bf44f84ac7c914305ff3824d8bd55987c12b17a0a3c"
      answer: "4d369065ef963677d13fc5a93db9dd7d3ca833b72005cd235a2b9ff7e8bbf3a1"
      options: "d724e057dd3332d8915e6a9159369eafc372124ded1851aaf55a637152f86ea4"
...
Supports deferred as a class, which is the record's name for action under a review that is owed.

**AI support.** Recorded as one of the eight traditions in `viable-options`' rationale, adopted for deferred as action under a review owed, and moved here under `prose-and-structure`, which holds that a tradition named only in prose carries no `bears` entry and no pin. It bears on the option that stands on `viable-options`' answer fact, whose second paragraph defines deferred as the recommendation acting with the node kept on the alignment frontier.
