...
facts:
  - name: answer
    ...
    boldness: moderate
    against: "A per-draft brief carries the index of every standing answer, so a sitting of several questions reads several times the tokens of the one batch it replaces, and the author's first-named judge is token efficiency; the design stands on their second, attention, and on timing, and the index is the lever against the cost."
  - name: authority
    options:
      - name: ratified
      - name: delegated
