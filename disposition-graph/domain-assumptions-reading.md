...
Proposed node: a reading under commons.systems/disposition-graph/instruments (new)

**The domain-assumptions reading**

A reading on domain assumptions (Zave and Jackson 1997; goal-oriented requirements, van Lamsweerde 2001), adopted: the specification holds under recorded assumptions about the world, and achieve and maintain are properties of the goal's criterion.

Facts: authority deferred until read; boldness moderate; persistence open question until written; then standing.

Depends on: `traditions-home`, `forms`

Drafted after q1 and q2.
