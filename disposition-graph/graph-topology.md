...
answer is the party the answer is meant to check, which is capture-shaped. That
test governs what the AI recommends where the author has not spoken, and the
author has spoken here, which is why it does not decide this fact — but it is why
