...
review:
  survey:
    ...
    text:
      question: "eb7f8fd93a92e1fcbb1c83c3088943d17e540319129ba62145bade021e30ec26"
      answer: "9a571d4d9274a1c3ba3f422cd9db1c69e6b9261993f62cf5b72c1b91f23fc7d8"
      options: "3541b9d2bf8533c99b53d791941764aa4d80ca2f47ebf0748723b9686e58c27a"
...
Supports the two frontiers, and supplies the reason they are derived and not stored.

**AI support.** Recorded as one of the eight traditions in `viable-options`' rationale, adopted for the two frontiers as the difference between the AI's recommendation and what stands, and moved here under `prose-and-structure`, which holds that a tradition named only in prose carries no `bears` entry and no pin. It bears on the option that stands on `viable-options`' answer fact, whose last paragraph is where the frontiers are declared projections that the record does not store.
