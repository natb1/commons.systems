...
review:
  survey:
    ...
    text:
      question: "208cb4a864bc0de0b532494164f03d4693f2ae6d30ebacbcab860ff341f1d334"
      answer: "87722bf6678aa87e47483dc18aa04d417914beade4f8c4b2ed456bb292cbed6a"
      options: "bb60e932e862990f99d985119a8dbe1912d04f499c9c7c421623184cb13c57ed"
...
`two-skills-one-package` is that shape, applied to an invocation surface instead of to an executable: the names are what a session types, and everything behind them is held in one place that neither name owns. The drift the author asked about is the question this tradition exists to answer, since what two names must not do is carry two copies of what they share; and the shared thing here comes in two kinds, mechanism and instruction, so the shape is satisfied only when each has one home, the first in a package and the second in the node both readings read.
