...
review:
  survey:
    ...
    text:
      question: "92d64daef42c1eb69c39a6d8581abdf3ae8e54a6112055f2802d52d93bedb1ca"
      answer: "4b4851bab19dc5ae609dfd0fe124b26f88785b3da4bb3521e7948bd0a0b7cc92"
      options: "b346371ded0ad297704bd09ce4aca3ea50b0f39aa4f612a0b30cd3c4ad70ef23"
...
Supports the shape of what reconciliation may write.

**AI support.** Recorded as one of the eight traditions in `viable-options`' rationale, adopted for what reconciliation may write, and moved here under `prose-and-structure`, which holds that a tradition named only in prose carries no `bears` entry and no pin. It bears on the option that stands on `viable-options`' answer fact, whose fourth paragraph sets out what the AI may write and what it may not.
