...
review:
  survey:
    ...
    text:
      question: "95912da3a62b4c2e0a4d32f6663b95c8a35bd1ea600835aa7218c265ffcd7445"
      answer: "c57391fefe3de50635dfd76e60464e66fff883ef74bce05c060d7e53b9d715b4"
      options: "06ea550dbe5937cb6afc9473b7799b9cc8357eec6c496017dd1c10c61fd575bd"
...
Supports the definition of viable, and defines the one judgment the AI is allowed to make about an option's presence.

**AI support.** Recorded as one of the eight traditions in `viable-options`' rationale, adopted for what viable means, and moved here under `prose-and-structure`, which holds that a tradition named only in prose carries no `bears` entry and no pin. It bears on the option that stands on `viable-options`' answer fact, whose third paragraph defines viable as not dominated on the record's criteria. The rationale of `evaluation` names the same tradition for the sense of frontier, so a second `bears` entry on that node's answer fact is owed when its options are settled.
