...
The standing option is still recommended only because no ruling has moved the
alignment page's answer yet; the option beside it is what this reading says
the moment that answer changes, and the recommendation moves with it.
