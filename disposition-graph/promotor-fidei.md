...
review:
  survey:
    ...
    text:
      question: "1dc46ec56ab7740eb1869bb9c10b5be73560be6c960268a8f49f45651a5dd92e"
      answer: "ac741d63940814b890dc9c1e477f4a6f502994b1dc0302649f2fec28cfbfcba7"
      options: "2464fa663779b2109221c3e85438a7366d3503a8530f4b50ee1897b5d3fc4220"
...
### The locus check the reading asked for, answered in part, 2026-09-09

The reading's source ends by naming what was still to be checked: the 1587 constitution by name and date, the articles of the 1983 constitution, and whether the office's later name, prelate theologian, carries the same function. The tradition survey run for `experts-and-adversarial-review` answers the third. Divinus Perfectionis Magister, article 10, keeps the Promoter of the Faith as Prelate Theologian, presiding over the theologians' meeting with the right to vote. The adversary was converted into a voting chair and not abolished as a party, so the paragraph below that reads the change as the office's removal overstates: what 1983 removed was the charge to argue against every cause, and what it kept was the officer, now judging among the judges. The argument that paragraph draws, that a permanent adversary was found to produce objections at the rate the office was staffed for, survives the correction, since it is about the charge and not the officer, and the record's answer to the manufactured objection still lives at `peirce-paper-doubt`. The survey did not open the constitution's text either, so the article is a citation and not a quotation, and the first two items of the locus check stand as they were. The reading's source and the paragraph are left as found and this entry is what corrects them, for the sitting that takes this node up.
