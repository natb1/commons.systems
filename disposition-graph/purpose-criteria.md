...
review:
  ...
  survey:
    date: 2026-09-05
    of: 0a1eaf1d6b2e38907133380a6e27b3c31aa16f09
facts:
  - name: answer
    options:
      - name: unguarded
...
Written by `packages/disposition/migrate.mjs` on 2026-09-07. The legacy text of commons.systems/disposition-graph/purpose-criteria stands at graph commit `2b696ace1e7c610bb4c205f1356f0cf19f016af6`, and this file is its projection into the content encoding of 2026-09-07 (`commons.systems/disposition-graph/dialogue`, `an-option-carries-its-content-its-words-and-its-case`). The `## Recommendation` fence became the content of `unguarded`. The record wrote no text of its own for `drafted-criteria`, so each carries the node as it stands with its own sentence in the answer's place: a transcription of what the option already said it would answer, and not an argument the migration wrote. Each is owed the text a sitting will give it. The draft review's pin `8a450005c1e68f597936f2f11260bcf98629d261` was already past the recommendation and is left as it stood. The survey's pin `71aaa5932eedca8ccc0c29b489f40e6bb2e3bc5e` is re-computed for the encoding as `0a1eaf1d6b2e38907133380a6e27b3c31aa16f09`; nothing it read changed.
