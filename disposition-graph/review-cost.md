  ...
  - name: answer
    options:
      ...
      - name: one-reading-per-draft
        source: ai
        ref: "2026-09-05"
      - name: neighbours-answered-not-whole
        source: ai
        ref: "2026-09-05"
...
#### neighbours-answered-not-whole

Split out and named so the author can rule on it apart from the rest: the neighbourhood is carried, but each neighbour by what it answers rather than by its whole file. It is not recommended separately because the recommended option contains it; it is listed because it is the clause that a reader who thinks the review should see everything would strike first, and because it was reached by measuring the recommended option's own reconciliation rather than by argument, which is a weaker provenance than the rest and the author should see that it is.
