...
on a node that carried none; the two options the design owes on
clean-context-review, `two-skills` on its answer fact and the shim's
supersession on a persistence fact, are recorded there with this node as
their source in the same round; the fixture repair the fence's cost
