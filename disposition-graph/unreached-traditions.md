...
### What the tradition survey of 2026-09-09 could not reach, 2026-09-09

The survey whose conclusion stands on `experts-and-adversarial-review`'s account ran with no search budget, as the entry above records, and it stated its gaps in three tiers rather than paraphrasing over them. This entry keeps the list, since a reading the record cannot check is one the record should know it cannot check, and a later sitting with a budget should open these before any option rests on them.

Reached at second hand only, the words held through a citing source and never the original: Lord Woolf's Interim Report (1995, ch. 23) and Final Report (1996, ch. 13), every quotation through the Law Reform Commission's consultation paper CP 52-2008; the Civil Procedure Rules, Part 35, as that paper transcribes them; Sackman's RAND report R-1283-PR and Woudenberg (1991), through Morgan (2014); and Mellers, Hertwig and Kahneman (2001), through Cowan and others.

Verified bibliographically and never opened: Murrie and others (2013), Psychological Science 24(10), on which the survey's adversarial-allegiance limb rests from the surveyor's knowledge and not from the paper; Murrie and Boccaccini (2015); Schwenk (1990), whose meta-analytic claim is likewise from knowledge and carries no effect size; Schweiger and others (1989); Mahoney (1977); Peters and Ceci (1982); Cole, Cole and Simon (1981); and Neal (2016).

Not reached at all: Damaška, The Faces of Justice and State Authority (1986), with no chapter or page locus, which the survey names its largest gap, because Damaška is the one source that would let the record ask what its process is for before asking what form its review should take, and whose reading the survey says should not be relied on until checked; Heuer and Pherson, Structured Analytic Techniques; the CIA's Tradecraft Primer (2009); the Team B episode (1976) and the Senate Select Committee's review of it (1978), not attempted, which the survey calls a real gap because it is the red-teaming tradition's best-documented case of an adversarial team performing worse than the incumbent it was convened against; Mason and Mitroff (1969, 1981) on the origin of dialectical inquiry, not searched; Plato, Republic 539b to 539d, whose wording in the survey is paraphrase and whose locus is from knowledge; Mill, On Liberty, chapter 2, so the survey's reading of it carries no quotation; Popper, section loci unverified; Howard on the neutral expert, whose bibliographic details were lost in extraction; Auld's Review of the Criminal Courts, chapter and paragraph unverified; and the paragraph pins within Cala Homes and JF v DPP, whose sentences are verbatim from the Law Reform Commission's paper and not from the judgments.

The order to open them in, where a sitting has the budget, is the order of what rests on them: Damaška first, then Team B, then Murrie and others (2013), since those are the three loci the survey's conclusion leans on and could not read.
