...
"chosen over" is a tradition adopted on an option that was not chosen.
Whether the relation moves from the node to the option, with the reading
unchanged, is the question the new words put to `readings`.
