...
facts:
  - name: answer
    ...
    boldness: high
    against: "The first limb of this argument is struck, and the strike is the author's. It ran that the author had scoped what persists to options 'categorized as viable by the AI' while this node's own rationale rejected keeping the rest, so that the recommendation reversed the author's words on the AI's reading of the regression purpose those same words gave; `words/2026-09-08/39` answers the probe that raised it and says the opposite, that a passed-over option is still viable because it does in the record what a rejected option does in an architecture decision record. What survives is the price and the bundling. The retention is still paid for in rows the author must read, a hundred and two at graph commit 417b8335 across twenty-eight nodes and a hundred and forty-one at 0daa4792 across thirty-eight, and the discretion the status was bought to remove survives untouched in which candidates the AI names at all, which the author's criterion narrows and does not close, since what an architecture decision record would keep is still the AI's judgment to make. And the amendment binds that decision to a second one, so one ratification would confer both the derivation of a class and what an option must carry, which is the bundling the record's own rule that a text answering two questions is two nodes exists to prevent."
  - name: authority
    options:
      - name: ratified
      - name: delegated
...
review:
  ...
  strength: weak
  date: 2026-09-07
  of: ec6557508cb7e3679cc3723efc5a05e66cec549a
  ...
  survey:
    date: 2026-09-09
    of: f32e63353b995ca7d13a70702d6a95d481a67bb5
    commit: 7eb63405f8cb47eeeb97bf86f5a5a87948c0efbb
    text:
      question: "23c44c92093c2f6224c8c28ddc23721aabee228cf6ad690bf57ec13dcee6a6a6"
      answer: "8505087c7d2ac6ef3e4caeab3769600b8f70684cce7a324a67729ff8ea6e2771"
      options: "d65b506a0b2a4c95d339b3bc00b377a1e572e7421f7087cc846b44ad119581a7"
      rivals: "19e07927b124b869e41373c1e374354b2da192feb304686077856dda623f6123"
      words: "8b953617701b8bb3693554ec10ae88d128a830609ea278307c9d7f4e1a947871"
    findings:
...
probes:
  - id: when-you-scoped-what-persists-to-the-opt
    ...
    fact: answer
    status: discharged
    reason: "Answered by the author at `words/2026-09-08/39`: \"Passed over options may still be recorded as viable as they serve a similar function as recording rejected option in an ADR. Anything that would be useful in an ADR is retained - esp. any options that were entertained during alignment dialogue for a record of why a choice was made.\" Viable excludes what an architecture decision record would not keep and nothing narrower, so an option the AI passed over is still viable in the author's sense, which is the direction the recommendation had already taken. The answer fact's `against` is amended with the words: its first limb, that the recommendation reverses the author's own scoping, is struck, and the price and the bundling stand. `commons.systems/disposition-graph/rejected` is settled with it, as this probe's `discharges` said it would be, and carrying that settlement to that node is a residue of this sitting."
form: rule
defines:
  - option
  - viable
...
record calls them unanswered, is answered by letting them.

**AI support.** The record wrote no case for this option; its support is owed.

**AI divergence.** Against it: the AI
...
- Folded: Minted from the author's disposition, 2026-09-04, at f0741490d538f17733f64bce56a14d8e122c8d34
...
- Folded: Reconciled under the grant, 2026-09-04, at f0741490d538f17733f64bce56a14d8e122c8d34
- Folded: The maieutic movement on the membership of an option list, 2026-09-04, at f0741490d538f17733f64bce56a14d8e122c8d34
- Folded: Evaluated twice: the membership rule, 2026-09-04, at f0741490d538f17733f64bce56a14d8e122c8d34
- Folded: Tested against the record it joins: the membership rule, 2026-09-04, at f0741490d538f17733f64bce56a14d8e122c8d34
- Folded: The recommendation and its facts, 2026-09-04, at f0741490d538f17733f64bce56a14d8e122c8d34
...
- Folded: Census corrected, 2026-09-05, at f0741490d538f17733f64bce56a14d8e122c8d34
...
- Folded: Clean-context review, 2026-09-07, of 27de140e, at f0741490d538f17733f64bce56a14d8e122c8d34
...
Written by `packages/disposition/migrate.mjs` on 2026-09-07. The legacy text of commons.systems/disposition-graph/viable-options stands at graph commit `2b696ace1e7c610bb4c205f1356f0cf19f016af6`, and this file is its projection into the content encoding of 2026-09-07 (`commons.systems/disposition-graph/dialogue`, `an-option-carries-its-content-its-words-and-its-case`). The `## Answer` became the content of `grant-from-a-ruling`; the `## Rationale` its `**AI support.**`; the `## Recommendation` fence became the content of `confirmed-is-a-derived-label-and-every-option-carries-its-content`; 6 `## Disposition` entries became the ledger entries words/2026-09-04/41, words/2026-09-04/42, words/2026-09-04/26, words/2026-09-07/2, words/2026-09-07/3, words/2026-09-07/4, referenced by 3 options the entry's own date names and by the recommended option for 3 the date named none; and `stands` left the answer fact. The content of `passed-over-options-stay (at 6c4d89c2)` was recovered from the commit at which the answer fact recommended it. The record wrote no text of its own for `authority-derived`, `grant-from-a-recommendation`, `viable-not-chosen-as-it-stands`, `a-stored-stamp-beside-the-rulings`, `a-fourth-response-defer`, `a-timestamp-as-the-pin`, `report-and-wait-on-a-divergence`, `delegated-node-returned-on-every-move`, `re-confirmation-from-the-periagogic`, `options-folded-into-the-rationale`, `keep-every-option-ever-recorded`, `adopted-is-a-status`, `class-rules-cited-not-restated`, `passed-over-shown-one-step-down`, `a-window-on-the-mark`, `confirmed-is-a-derived-label`, so each carries the node as it stands with its own sentence in the answer's place: a transcription of what the option already said it would answer, and not an argument the migration wrote. Each is owed the text a sitting will give it. The draft review's pin `e96dba5933af83d5353462966bca995e353c04fd` is re-computed for the encoding as `e98d683eae2469f7ac97e4048b077dd7dcaecfd8`; nothing it read changed. The survey's pin `1598c6ec57c8e88ac3a80b15f46d69ba69f93eb2` was already past the recommendation and is left as it stood.
...
### The probe on what `viable` excludes, discharged, 2026-09-08

The author, at `words/2026-09-08/39`, answering the review's probe of 2026-09-05:
"Passed over options may still be recorded as viable as they serve a similar function
as recording rejected option in an ADR. Anything that would be useful in an ADR is
retained - esp. any options that were entertained during alignment dialogue for a
record of why a choice was made."

What the words settle, and what they leave. They settle the direction: the scoping
phrase "categorized as viable by the AI" was never meant to drop the candidates the AI
passed over, so the recommendation's retention is the author's and not a reversal of
theirs. They give the record a criterion it did not have. `Viable means not dominated
on the record's criteria, in the AI's judgment` is circular as a test, since the
criteria are the AI's too; the architecture decision record is a standard outside this
record, and the question it puts is answerable by someone other than the party whose
judgment is at issue. That sentence is now in the recommended option's content. What
the words leave open is who applies the criterion, which is still the AI, so the
discretion the `against` names survives in narrowed form and the `against` says so.

The strike is recorded rather than made silently, as the evaluation node requires of a
status the AI lifts. The first limb of the answer fact's `against` was the reversal
argument, and it is struck on the author's word; the price at a hundred and forty-one
option rows and the bundling of two decisions in one ratification are untouched, and
neither was the probe's subject.

The probe's `discharges` named a second effect: `commons.systems/disposition-graph/rejected`,
"whose own `against` says that node has no ground of its own if the author rules the
other way one node earlier". The author ruled this way, so that node keeps its ground.
Carrying the settlement onto it is residue of this sitting and is not done here.

### Frontier survey, 2026-09-09, of f32e6335

Read in clean context by a subagent given the whole graph and nothing of the sitting, judging this node's recommendation against every other node. The survey gives no verdict.

Findings:

- The recommendation `an-option-carries-a-selection-per-party` mints a per-party selection the record has no act to write. `festo-surrendered-subject-matter` records it verbatim: "The recommendation mints those two marks and mints no corresponding instrument for lifting either." and "So on the recommendation as it stands there is a mark with no producer and no retraction, on a row the machinery reads." `recording`'s ruling responses are `confirm` and `edit`, and no option on `recording`'s answer fact adds a third.
- This node claims the term `grant` and leaves it blank while another node defines the same thing under a different name. Its header reads "- Defines: `option` (no gloss yet); `viable` (no gloss yet); `grant` (no gloss yet)", and `what-acts-during-bootstrap` defines "`bootstrap authority` — The author's grant, given explicitly in their words for one alignment sitting and reaching every alignment in it; the term is the author's, and the grant is the thing this node calls a grant." The record therefore has one definition of the grant, made on a node that names it something else, and an empty claim to the term on this one.

Strongest counter-argument (moderate): The answer makes an option's row carry a selection per party, and the record has no act that writes one: `recording`'s two ruling responses are `confirm` and `edit`, and the reading `festo-surrendered-subject-matter` names the consequence as "a mark with no producer and no retraction, on a row the machinery reads". That is not a gap in the implementation but in the disposition, because `what-acts-during-bootstrap` makes the unconfirmed choice the first term of the convergence reconciliation acts on, so this answer's central object is one the record cannot produce, cannot retract, and nonetheless reads.

The session's reply: Both findings kept. On the per-party selection: the mark this node's recommendation puts on a row is one no act writes and none lifts, and the repair is recorded on `recording` rather than here, since that node owns the ruling responses and this one only reads the mark. On the grant: the survivor is `what-acts-during-bootstrap`, which carries the author's own term `bootstrap authority` and a gloss behind it, so this node drops the claim to `grant` or points at it rather than glossing the same thing twice under two names.
...
Also named: commons.systems/disposition-graph/what-an-option-row-carries, commons.systems/disposition-graph/recording, commons.systems/disposition-graph/what-acts-during-bootstrap.
