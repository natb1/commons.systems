...
rationale: >-
  ...
  avoidance stays auditable instead of tacit. A record with `status: raw` is a
...
attributes:
  fields:
    ...
    - "review_window: maximum age of last_assessed (and, where a recovery drill
      applies, last_exercised) before review is due — the cadence
      strategy-exercise-recovery-paths' threshold reads"
---
