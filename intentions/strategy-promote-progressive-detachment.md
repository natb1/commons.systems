...
tooling_goals: []
success_signal:
  observable: adoption with migration freedom — users who can leave, forks, derivative projects, practitioners adapting the workflow independently
  sensor: fork/derivative counts and user-migration checks reviewed at office-hours
  threshold: at each pursued tier, the tier's signal is present and no user or buyer is locked in
  is_proxy: false
attributes:
