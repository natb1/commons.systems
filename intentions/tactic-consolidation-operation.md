...
- The append rule as restated: appends are the cheap default edit mode between
  consolidations; rewrites happen only through this operation; disposition
  stamps still append in-file; git carries the permanent history.
