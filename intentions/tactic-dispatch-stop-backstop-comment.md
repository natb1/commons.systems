...
**Verification.** Prose: read the amended comment against `packages/intentionsutil/scripts/graph-commit`'s far-ahead handling and confirm the claim matches. No test surface — comment-only.
