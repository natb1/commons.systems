...
- After this lands and is in active use, watch actual `graph-commit`
  ...
  **Skipped at office-hours (2026-07-21):** reviewed and explicitly not
  tracked as a follow-up tactic or scheduled check — the code itself is
  fully verified (test-graph-commit.sh 31/31), and this observation is
  left informal rather than made a tracked deliverable.
