...
blocked_by: []
office_hours:
  reason: "/fix-checks retry budget exhausted: 30 attempts concluded with PR #3010
    still red (execution.fix.attempt=31, since 2026-08-01) — the 3-attempt cap
    is exhausted."
  since: 2026-08-01
  recommendation: "Review the fix-checks accumulator (tmp/fix-checks-summary.md in
    ...
    tactic-graph-router-live-worker-read-robust with a fresh retry budget
