...
rationale: "Observed live twice in succession on 2026-08-13, on node
  ...
  for 734s and SUCCEEDED -- it resolved five conflicts against c3c229f0,
  git rm'd three files origin/main had already retired, pushed merge commit
  855a060e, and flipped PR #3075 from CONFLICTING to MERGEABLE/CLEAN with all
  23 checks passing -- and the ladder halted `stalled`. SECOND instance, a qa
