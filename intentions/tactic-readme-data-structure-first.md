...
## Approved framing (draft copy, refine at implementation)
...
## Copy constraints from the interview (all recorded as clarifications on strategy-data-structure-first)
