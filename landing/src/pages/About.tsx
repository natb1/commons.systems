export function About() {
  return (
    <>
      ...
      <p>One person handles contracting, project management, and the build. The person you give requirements to is the person who writes the code — no middle-men, no team to onboard. Scope is set with honesty based on what I can build and hand off well, rather than an open-ended platform or service commitment.</p>
