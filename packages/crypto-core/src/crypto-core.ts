...
export async function deriveKey(
  ...
  return subtleCrypto.deriveKey(
    { name: "PBKDF2", salt: salt as Uint8Array<ArrayBuffer>, iterations: PBKDF2_ITERATIONS, hash: "SHA-256" }, // type-safety-ok: SubtleCrypto requires Uint8Array<ArrayBuffer>; getRandomValues returns Uint8Array
    keyMaterial,
...
export async function encryptData(
  ...
  const ciphertext = await subtleCrypto.encrypt(
    { name: "AES-GCM", iv: iv as Uint8Array<ArrayBuffer> }, // type-safety-ok: SubtleCrypto requires Uint8Array<ArrayBuffer>; getRandomValues returns Uint8Array
    key,
