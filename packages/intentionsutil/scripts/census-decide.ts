...
// import { verifyCompletion, partitionDonePresent } from this file only.
//
 ...
 * each by `verifyCompletion` into prunable ids and defect ids+reasons.
 */
