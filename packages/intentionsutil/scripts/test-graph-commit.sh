...
#  48. delete/modify divergence: another writer's deletion lands on main FIRST
...
# --- Case 48: delete/modify divergence — deletion lands first, edit races it via stale --base ---
